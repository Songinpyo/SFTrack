...
class DefaultPredictor:
    ...
    def __init__(self, cfg):
        ...
        # model_weight = torch.load('fast_reid/demo/vehicleid_bot_R50-ibn.pth')["model"]
        # model_weight = {
        #     k.replace("heads.bnneck.num_batches_tracked", "heads.bnneck.running_mean").replace("heads.", ""): v for k, v
        #     in model_weight.items() if "heads." in k}
